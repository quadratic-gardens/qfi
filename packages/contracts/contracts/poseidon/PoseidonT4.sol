...
library PoseidonT4 {
  ...
  function hash3(uint[3] memory) public pure returns (uint) {
    assembly {
      ...
      function pRound(c0, c1, c2, c3) {
        ...
        mstore(
          ...
          addmod(
            addmod(
              addmod(mulmod(state0, M00, F), mulmod(state1, M10, F), F),
              mulmod(state2, M20, F),
              F
            ),
            mulmod(state3, M30, F),
        ...
        mstore(
          ...
          addmod(
            addmod(
              addmod(mulmod(state0, M01, F), mulmod(state1, M11, F), F),
              mulmod(state2, M21, F),
              F
            ),
            mulmod(state3, M31, F),
        ...
        mstore(
          ...
          addmod(
            addmod(
              addmod(mulmod(state0, M02, F), mulmod(state1, M12, F), F),
              mulmod(state2, M22, F),
              F
            ),
            mulmod(state3, M32, F),
        ...
        mstore(
          ...
          addmod(
            addmod(
              addmod(mulmod(state0, M03, F), mulmod(state1, M13, F), F),
              mulmod(state2, M23, F),
              F
            ),
            mulmod(state3, M33, F),
