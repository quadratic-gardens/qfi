...
describe("Deploy - QV Infrastructure Smart Contracts", () => {
  ...
  it("deploys Poseidon Contracts", async () => {
    ...
    expect(
      await poseidonT3.poseidon([BigNumber.from(0), BigNumber.from(0)])
    ).to.be.equal(
      BigNumber.from(
  ...
  it("deploys GrantRoundFactory Contracts", async () => {
    ...
    await expect(
      (
        await grantRoundFactory.deployTransaction.wait()
      ).status
    ).to.not.equal(0)
  })
  ...
  it("deploys PollFactory Contracts", async () => {
    ...
    await expect(
      (
        await pollFactory.deployTransaction.wait()
      ).status
    ).to.not.equal(0)
  })
  ...
  it("deploys MessageAqFactory Contract", async () => {
    ...
    await expect(
      (
        await messageAqFactory.deployTransaction.wait()
      ).status
    ).to.not.equal(0)
  })
  ...
  it("deploys constantInitialVoiceCreditProxy Contract", async () => {
    ...
    await expect(
      (
        await constantInitialVoiceCreditProxy.deployTransaction.wait()
      ).status
    ).to.not.equal(0)
  })
  ...
  it("deploys freeForAllGateKeeper Contract", async () => {
    ...
    await expect(
      (
        await freeForAllGateKeeper.deployTransaction.wait()
      ).status
    ).to.not.equal(0)
  })
  ...
  it("deploys Recipient Registry Contract", async () => {
    ...
    await expect(
      (
        await optimisticRecipientRegistry.deployTransaction.wait()
      ).status
    ).to.not.equal(0)
  })
  ...
  it("deploys ERC20 token Contract", async () => {
    ...
    await expect(
      (
        await baseERC20Token.deployTransaction.wait()
      ).status
    ).to.not.equal(0)
  })
  ...
  it("transfers PollFactory ownership to Quadratic Funding Infrastructure Contract", async () => {
    grantRoundFactory = await GrantRoundFactory.deploy()
    const tx = await grantRoundFactory.setRecipientRegistry(
