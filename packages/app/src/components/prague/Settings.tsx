    ...
    <Container h="full" w="full" overflowY={"scroll"} right="-24px" top={0} left={0} position="absolute">
      <VStack mt={20} spacing={10} h="full" alignItems="flex-start">
        ...
        <VStack spacing={6} alignItems="flex-start">
          ...
          All wallets that hold a redeemed NFT ticket are able to cast a Ballot for which project should get the funding. Casting a Ballot requires you to have a Polygon/Etherum wallet with some MATIC to pay for the transaction gas (a small amount of MATIC will be airdropped to all NFT ticket holders) and a valid ballot key. Voting is pseudoanonymous, but to submit your Ballot you will be sent your MACI key to your email address by the ETHBarcelona team. 
        ...
        <VStack spacing={2} alignItems="flex-start">
          ...
          <Text >
          During the event you can ask questions to the team behind this funding process and make have a workaround if you are not able to use the MACI key sent to your email. The team will be on stage to briefly present this process during the event, if in doubt ask any of the ETHBarcelona volunteers to point you to them if you have questions.
          </Text>
        </VStack>
      </VStack>
    </Container>
