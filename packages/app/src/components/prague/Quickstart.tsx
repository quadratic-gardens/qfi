    ...
    <Container h="full" w="full" overflowY={"scroll"} right="-24px" top={0} left={0} position="absolute" sx={{
      ...
      <VStack mt={20} spacing={10} h="full" alignItems="flex-start">
        <VStack spacing={6} alignItems="flex-start">
          ...
          <Text fontFamily={"archivo"}>
            Below you will find instructions to help support local projects through a Quadratic Funding (QF) round taking place only at ETHPrague.
          </Text>
          <Text fontFamily={"archivo"}>
        ...
        <VStack spacing={6} alignItems="flex-start">
          ...
          <Text fontFamily={"archivo"}>
            Visit us in the Quadratic Funding booth at ETHPrague to get your inventory card! This contains two sets of keys that make up your unique (but anonymous) voter ID.
          </Text>
              ...
              <AccordionPanel pb={4}>
                <VStack spacing={6} alignItems="flex-start">
                  ...
                  <Text fontSize="xs" fontFamily={"archivo"}>
                    On the left side of your inventory card is a mnemonic and QR code. These are keys to a Gnosis Chain wallet which you will use to build your ballot for the Quadratic Funding round.
                  </Text>
        ...
        <VStack spacing={6} alignItems="flex-start">
          ...
          <Text fontFamily={"archivo"}>
            We recommend the Status app for the smoothest experience since it has wallet, browser and xDai RPC already integrated (plus you can use it to send super-private messages to all your new hackathon friends!).
          </Text>
          <Accordion allowToggle>
            <AccordionItem border="none">
              <VStack>
              ...
              <AccordionPanel pb={4}>
                <VStack spacing={6} alignItems="flex-start">
                  ...
                  <Text fontSize="xs" fontFamily={"archivo"}>
                    In your profile, go to Advanced =`{'>'}` Network and change to xDai Chain. You will need to restart the app for the network change to take effect.
                  </Text>
                  <Heading size="xs">Set up your ballot</Heading>
                  <Text fontSize="xs" fontFamily={"archivo"}>
                    In the Status browser, tap the colored icon at the bottom center of the screen to connect the account you just added. Go to qf.ethprague.com/#/begin. Hit “Connect” and authorize the app to access your address. Scan the QR to add your MACI key and hit “Save” - and you are all set! Go forth and vote.
                  </Text>
                  <Text fontSize="xs" fontFamily={"archivo"}>
              ...
              <AccordionPanel pb={4}>
                <VStack spacing={6} alignItems="flex-start">
                  ...
                  <Text fontSize="xs" fontFamily={"archivo"}>
                    In your wallet app:
                    <OrderedList>
                      <ListItem>Switch network to xDai/Gnosis Chain. There are instructions for MetaMask <Link href='https://metamask.zendesk.com/hc/en-us/articles/360052711572-How-to-connect-to-the-Gnosis-Chain-network-formerly-xDai' isExternal>
                        <Icon as={HiExternalLink} boxSize={4} color="gray.500" />
                      </Link> or you can use Chainlist
                        <Link href='https://chainlist.wtf/' isExternal>
                          <Icon as={HiExternalLink} boxSize={4} color="gray.500" />
                        </Link> to automatically add Gnosis Chain in many Web3 wallets. Always use caution when connecting to new networks!</ListItem>
                      <ListItem>Create a new account using the xDai mnemonic or private key QR from your card.</ListItem>
                    </OrderedList>
                  </Text>
                  <Text fontSize="xs" fontFamily={"archivo"}>
                    Choose your favorite browser and navigate to
                    <Link href='https://qf.ethprague.com/#/begin'> qf.ethprague.com/#/begin</Link>
                  </Text>
                  <Text fontSize="xs" fontFamily={"archivo"}>
