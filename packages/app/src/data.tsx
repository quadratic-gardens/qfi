...
let projects = [
  ...
  },
  {
    ...
    description:
      "Building on philosophical background of Charter 77, Czechoslovak dissident movement, and cryptoanarchy from the Cypherpunk movement, Paralelní Polis was formed in 2014. As a nonprofit, Polis provides public with open space to learn, collaborate and explore. Topics of this content are represented by the triangle logo - Art, Science and Technology. For more than 8 years, Polis served to many local communities - hackers, artists, biologists and environmentalists, activists, philosophers, crypto communities, AI researchers, etc. Local and also global communities are attracted to various concepts Paralelní Polis includes: Bitcoin Coffee - educational café where anybody can just come and get his first coffee for Bitcoin with our help. The first place in the world to accept only cryptocurrencies has been pioneering this topic and onboarding local people to crypto ecosystem extensively. PaperHub - coworking space, hub of like minded peers from many various communities. Institute of Cryptoanarchy - hosting local meetups, events and conferences, think tank focused on sustaining ideas of cypherpunk.  YT studio - multimedia studio which serves us and public for creating youtube educational content, podcasts, streams, etc.  Bordel - hackerspace, manifestation of chaos where the actual tools are being build and used by local hackers. We are thrilled to welcome Ethereum community in Prague and hope you will enjoy the best time in Paralelní Polis.",
  ...
  {
    name: "United Vision",
    tagline: "United Vision aims to strengthen communities and empower individuals through long-term volunteering and environmental education.",
    description:
    "United Vision is a Czech NGO founded in 2011 in Prague. The organisation focuses on the topics of community development and protection of nature, through volunteering and informal education. We promote respect towards people, animals and nature, and raise awareness of the limitations of our planet. We work with people of all ages, but primarily young people, by encouraging active participation and engagement in these topics. This is done through long-term volunteering activities, in cooperation with partner organisations and communities. We encourage volunteering as a way to empower people, regardless of any disadvantages they may face, believing that active participation, and development of key competencies are important parts of life. ",
    problemSpace:
  ...
  {
    name: "Crypto Portal",
    tagline: "Prague’s first NFT gallery, featuring NFTs from a range of well-known local and international artists, with an emphasis on education, collaboration, and exploration.",
    description:
  ...
  {
    name: "Gwei.cz",
    tagline: "Gwei.cz is a Czech/Slovak community of supporters of the Ethereum platform and the decentralized finance (DeFi) movement.",
    description:
    ...
    problemSpace:
      "Spreading awareness of decentralised finance. And local support for projects",
    address: "0x41198CE04A731ad2F3F397FA898F9f34b9fe7002",
    id: "8",
    url: "https://gwei.cz/",
  ...
  },
  {
    ...
    tagline: "We are a non-profit and independent association. Our target is to spread awareness about open and decentralised technologies and connect people with similar interests.",
    description:"Currently, we are organising the biggest Czech crypto conference happening a week before ETHPrague. We would like to continue organising meetups and conferences in the future. We have grown from the local Czech Ethereum community gwei.cz. The first event we organised was ETHBrno which led to creating UTXO Foundation and organising the UTXO conference. We felt that conferences for new crypto users are very commercial and not really open in the Czech Republic. We are changing that as I write this!",
    problemSpace:
  ...
  },
  {
    ...
    description:"NFTurtle is a decentralized non-profit organization based on the Ethereum blockchain committed to protecting sea turtles and their habitats worldwide. Our vision is a future where sea turtles and their nesting beaches are protected and safe from the main threats of poachers and other factors that are causing the rapid decline of sea turtle species. The main goal is to obtain funding to open newly protected nesting sites via a small internal crowdfunding scheme. We want to utilize the momentum of the current NFT market hype to create a strong bond between blockchain technologies and organized threatened species conservation groups. Thanks to cooperation with established non-profit organizations, we can offer NFTs that represent particular living sea turtles in the real world. So, unlike most mainstream NFT projects, we connect the virtual world with reality. How does it works? Each turtle has a unique facial scale pattern that is akin to a human fingerprint. With the use of multiple computer-assisted algorithms which are comparable to human facial recognition programs, we can identify and track the progress of the ID turtles. Once entered into the identification program we can then digitize and convert each individual turtle in the database into an NFT.",
    problemSpace:
