...
let projects = [
  ...
  },
  {
    ...
    tagline:
      "An open platform for learning, researching and building free (libre) solutions for society.",
    problemSpace:
  ...
  },
  {
    ...
    tagline:
      "CZK foreign exchange rate on-chain, similar to other FIAT currencies, for any Web3 project.",
    problemSpace:
  ...
  {
    name: "Gwei.cz",
    tagline: "A Czech/Slovak community of supporters of the Ethereum platform and the decentralized finance (DeFi) movement.",
    description:
