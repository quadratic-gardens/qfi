          ...
          >
            <GridItem colSpan={{ base: 1, md: 8 }} rowSpan={{ md: 2 }}>
              <Text textAlign="justify">
                {t(
                  "Apply for the quadratic funding round with your project! If you are building tools for the Ethereum ecosystem or L2, if you are involved in Ethereum community education, if you do research or other activities for the Ethereum ecosystem, don't hesitate to apply!"
                )}
              </Text>
              <GridItem colSpan={{ base: 1, md: 8 }} rowSpan={{ md: 2 }}>
                <Accordion
                    ...
                    <AccordionPanel pb={4}>
                      <Text textAlign="justify" fontSize="md">
                        <UnorderedList>
                          <ListItem mb={4}>
                            {t(
                              "The project needs to be based, or working with local communities, or in the surroundings of Argentina."
                            )}
                          </ListItem>
                          <ListItem mb={4}>
                            {t(
                          ...
                          <ListItem mb={4}>
                            ...
                            <a
                              href={"http://www.linfo.org/public_good.html"}
                              rel="noreferrer"
                              target="_blank"
                            >
                              {t("here")}
            ...
            <GridItem colSpan={{ base: 1, md: 8 }} rowSpan={{ md: 2 }}>
              ...
              <Text textAlign="justify" mb={4}>
                {t(
                  "This financing is a donation and has no associated reports, returns, or obligations on the part of the project. How much each project receives will be decided by ETHLatam attendees who vote during the event. If you are unsure about this, feel free to contact the team at sponsors@ethlatam.org."
                )}
              </Text>
              <Text textAlign="justify" mb={4}>
                {t(
              ...
              <Text textAlign="justify" mb={4}>
                {t(
                  "If you post on Twitter, tag @ETHLatam and use the corresponding hashtags to achieve greater reach. You can also post within the"
                )}{" "}
                <a
                  href={"https://t.me/ethlatam"}
                  rel="noreferrer"
                  target="_blank"
                >
            ...
            <GridItem colSpan={{ base: 1, md: 8 }} rowSpan={{ md: 2 }}>
              ...
              >
                <AccordionItem border="none" w={"full"}>
                  ...
                  >
                    <Heading size="md">
                      {t("What do you need to do to sign up?")}
                    </Heading>
                    <AccordionIcon></AccordionIcon>
                  </HStack>
                  <AccordionPanel pb={4}>
                    <Text textAlign="justify" fontSize="md">
                      <UnorderedList>
                        <ListItem mb={4}>
                          {t(
                            "The registration deadline is August 11th at 11:55 pm (Argentine time)."
                          )}
                        </ListItem>
                        <ListItem mb={4}>
                          {t("Submit your project using this form:")}:{" "}
                          <a
                            href={"https://forms.gle/JnHUU5suGk7JK5LH6"}
                            rel="noreferrer"
                            target="_blank"
                          >
