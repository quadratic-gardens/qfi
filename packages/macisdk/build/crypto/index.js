...
const hash2 = (elements) => hashN(2, elements);
const hash3 = (elements) => hashN(3, elements);
const hash4 = (elements) => hashN(4, elements);
const hash5 = (elements) => hashN(5, elements);
/*
 ...
 */
const encrypt = (plaintext, sharedKey, nonce = BigInt(0)) => {
 ...
 */
const decrypt = (ciphertext, sharedKey, nonce, length) => {
...
export { genRandomSalt, genPrivKey, genPubKey, genKeypair, genEcdhSharedKey, encrypt, decrypt, sign, sha256Hash, hashOne, hash2, hash3, hash4, hash5, hash13, hashLeftRight, verifySignature, G1Point, G2Point, stringifyBigInts, unstringifyBigInts, formatPrivKeyForBabyJub, IncrementalQuinTree, AccQueue, NOTHING_UP_MY_SLEEVE, SNARK_FIELD_SIZE, bigInt2Buffer, packPubKey, unpackPubKey, };
