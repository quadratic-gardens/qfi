import { Scalar, ZqField, utils as ffutils } from "ffjavascript"

// const poseidon_constants = require('./poseidon_constants.json');
import poseidon_constants from "./poseidon_constants.json" assert { type: "json" }
...
// const {  } = require("ffjavascript").utils;
...
const { C, M } = ffutils.unstringifyBigInts(poseidon_constants)
